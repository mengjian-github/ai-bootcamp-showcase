...
# 提交和投票截止时间（格式：YYYY-MM-DDTHH:mm:ss+08:00）
...
- 作品链接：确保链接有效且可公开访问
- **截止时间**：请注意页面顶部显示的截止时间，超过截止时间将无法提交作品或进行投票

## ⏰ 截止时间功能

### 功能说明
- 平台支持设置作品提交和投票的统一截止时间
- 截止时间通过环境变量 `NEXT_PUBLIC_SUBMISSION_DEADLINE` 配置
